...
\newcommand\univCname{國立成功大學}
\newcommand\univEname{National Cheng-Kung University}
\newcommand{\UnivEname}{\expandafter\MakeUppercase\expandafter{\univEname}}
\newcommand\deptCname{資訊工程研究所}
\newcommand\fulldeptEname{Compute Science and Information Enginerring}
\newcommand\deptEname{Compute Science and Information Enginerring}
\newcommand{\DeptEname}{\expandafter\MakeUppercase\expandafter{\deptEname}}
\newcommand\collEname{College of Electrical Engineering \& Computer Science}
...
%
%\vspace{6cm}
%\normalsize{\copyright Copyright by \myEname ~ \eYear}
%\end{center}
%\end{titlepage}
%%%%%%%%%%%%%%%
...
% Use normal size font in following pages.
\normalsize
% 無 header，但在浮水印模式下會有浮水印
\thispagestyle{plain}
...
%
\newpage
\chapter*{\protect\makebox[2.5cm][s]{摘要}}
